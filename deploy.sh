...
echo "     • Landing Page:   https://vayadelivery.com (and https://www.vayadelivery.com)"
echo "     • Customer App:   https://app.vayadelivery.com (or https://customer.vayadelivery.com)"
echo "     • Driver Partner: https://partner.vayadelivery.com"
echo "     • Admin Portal:   https://admin.vayadelivery.com"
echo ""
