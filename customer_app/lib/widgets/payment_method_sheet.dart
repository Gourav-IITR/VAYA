...
class PaymentMethodSheet extends StatefulWidget {
  final double amount;
  final String purpose; // 'booking_fare', 'wallet_topup'
...
class _PaymentMethodSheetState extends State<PaymentMethodSheet> {
  ...
  String _selectedMethod = 'intent'; // 'intent' or 'vpa'
  ...
  Future<void> _processPayment({String? package, String? vpa}) async {
    ...
    try {
      ...
      if (!mounted) return;
      Navigator.pop(context); // Close the custom payment sheet before app handoff
                    ...
                    child: Row(
                      children: [
                        ...
                        Icon(
                          ...
                          size: 16,
                          color: isSelected ? const Color(0xFFFFB800) : const Color(0xFF94A3B8),
                        ),
                      ],
                    ),
                  ),
